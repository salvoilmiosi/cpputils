...
struct BackMapped
{
    V value;
    K* ptr_key;
    BackMapped(const V& v = V{}, K* pk = nullptr) requires std::is_copy_constructible_v<V> : value{ v }, ptr_key{ pk } {}
    BackMapped(V&& v = V{}, K* pk = nullptr) : value{ std::move(v) }, ptr_key{ pk } {}
};
...
public:
    ...
    std::pair<iterator, bool> emplace(Args&&... args)
    {
        ...
        {
            detail::BackMapped<const key_type, mapped_type> v{ std::move(value.second) };
